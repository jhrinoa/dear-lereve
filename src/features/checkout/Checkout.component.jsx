  ...
  return (
    <Container sx={{ pt: 2, pb: 6 }} maxWidth="md">
      ...
      <TextField
        ...
        >
          <FormControlLabel value="Coquitlam" control={<Radio />} label="Coquitlam" />
          <FormControlLabel value="Langley" control={<Radio />} label="Langley" />
          <FormControlLabel value="Burnaby" control={<Radio />} label="Burnaby" />
          <FormControlLabel value="Delivery" disabled={totalPrice < 150} control={<Radio />} label="Delivery option available only when total price is more than $150" />
        </RadioGroup>
